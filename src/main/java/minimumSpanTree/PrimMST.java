...
public class PrimMST<Weight extends Number & Comparable> {
        ...
        for (Object item:G.adj(v)){
            ...
            if(!marked[w]){
                ...
                if(edgeTo[w] == null){
                    edgeTo[w] = e;
                    ipq.insert(w, e.wt());
                }else if(e.wt().compareTo(edgeTo[w].wt()) < 0){ // 如果曾经考虑这个端点, 但现在的边比之前考虑的边更短, 则进行替换
                     edgeTo[w] = e;
                     ipq.change(w,e.wt() );
                }
    ...
    public static void main(String[] args) {
        ...
        String filename = "C:\\Users\\Nicholas\\IdeaProjects\\dataStructure\\src\\main\\java\\minimumSpanTree\\testG1.txt";
        int V = 8;
